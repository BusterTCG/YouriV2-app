...
INSERT INTO "new_Deal" ("artistAmount", "artistStatus", "budgetAmount", "budgetPaidAt", "budgetPaymentStatus", "cachetsFeesPct", "capacity", "category", "coRealGrossCa", "coRealKnPct", "commissionAmount", "commissionPct", "contractSigned", "createdAt", "createdById", "date", "deletedAt", "description", "endTime", "grossAmount", "id", "invited", "isMultiDate", "multiDateDates", "notes", "organizerCity", "organizerCompany", "organizerId", "organizerName", "paying", "performanceCount", "prodExePct", "showName", "showTime", "status", "ticketingReady", "ticketingUrl", "title", "updatedAt", "venueAddress", "venueCity", "venueDealKind", "venueId", "venueName", "venueRoomId", "vhrBooked") SELECT "artistAmount", "artistStatus", "budgetAmount", "budgetPaidAt", "budgetPaymentStatus", "cachetsFeesPct", "capacity", "category", "coRealGrossCa", "coRealKnPct", "commissionAmount", "commissionPct", "contractSigned", "createdAt", "createdById", "date", "deletedAt", "description", "endTime", "grossAmount", "id", "invited", "isMultiDate", "multiDateDates", "notes", "organizerCity", "organizerCompany", "organizerId", "organizerName", "paying", "performanceCount", "prodExePct", "showName", "showTime", "status", "ticketingReady", "ticketingUrl", "title", "updatedAt", "venueAddress", "venueCity", "venueDealKind", "venueId", "venueName", "venueRoomId", "vhrBooked" FROM "Deal";
DROP TABLE "Deal";
