...
/**
 * Sheet = drawer latéral (slide depuis un côté de l'écran). Construit
 * au-dessus de Radix Dialog comme la convention shadcn.
 */
...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      {...props}
    >
      {/* Required by Radix for accessibility — supply at least a Title in
          consumers via SheetTitle, but provide visually-hidden default to
          avoid runtime warnings when one is missing. */}
